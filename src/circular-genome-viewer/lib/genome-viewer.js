...
/*! Genome Viewer - v1.0.3 - 2013-11-28
...
ChromosomePanel.prototype = {
    ...
    showContent: function () {
        ...
        $(this.collapseDiv).children().first().removeClass('fa fa-plus');
        $(this.collapseDiv).children().first().addClass('fa fa-minus');
    },
    hideContent: function () {
        $(this.svg).css({display: 'none'});
        this.collapsed = true;
        $(this.collapseDiv).addClass('active');
        $(this.collapseDiv).children().first().removeClass('fa fa-minus');
        $(this.collapseDiv).children().first().addClass('fa fa-plus');
    },
