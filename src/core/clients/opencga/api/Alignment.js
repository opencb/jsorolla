...
export default class Alignment extends OpenCGAParentClass {
    ...
    */
    runBwa(data, params) {
        return this._post("analysis/alignment", null, "bwa", null, "run", data, params);
    }
    ...
    */
    runCoverageIndex(data, params) {
        return this._post("analysis/alignment", null, "coverage/index", null, "run", data, params);
    }
    ...
    */
    statsCoverage(file, gene, params) {
        return this._get("analysis/alignment", null, "coverage", null, "stats", {file, gene, ...params});
    }
    ...
    */
    runDeeptools(data, params) {
        return this._post("analysis/alignment", null, "deeptools", null, "run", data, params);
    }
    ...
    */
    runFastqc(data, params) {
        return this._post("analysis/alignment", null, "fastqc", null, "run", data, params);
    }
    ...
    */
    runIndex(data, params) {
        return this._post("analysis/alignment", null, "index", null, "run", data, params);
    }
    ...
    */
    runSamtools(data, params) {
        return this._post("analysis/alignment", null, "samtools", null, "run", data, params);
    }
    ...
    * @param {Object} data - Alignment stats params.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - study.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An id will be autogenerated automatically if not
    *     provided.
    ...
    */
    runStats(data, params) {
        return this._post("analysis/alignment", null, "stats", null, "run", data, params);
    }
