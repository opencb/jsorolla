 ...
 * Autogenerated on: 2020-07-15 08:53:00
 * 
...
export default class Variant extends OpenCGAParentClass {
    ...
    * @param {Boolean} [params.plotCopyNumber = "true"] - Plot copy-number track. The default value is true.
    * @param {Boolean} [params.plotIndels = "true"] - Plot INDELs track. The default value is true.
    * @param {Boolean} [params.plotRearrangements = "true"] - Plot rearrangements track. The default value is true.
    * @param {String} [params.density = "LOW"] - Density plot: LOW, MEDIUM or HIGH. The default value is LOW.
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    circos(params) {
    ...
    *     is used to filter variants before computing relatedness, e.g.: 1kg_phase3:CEU>0.35 or cohort:ALL>0.05.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - Study [[user@]project:]study where study and project can be either the ID or UUID.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @param {Object} data - Sample QC analysis params.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - Study [[user@]project:]study where study and project can be either the ID or UUID.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    */
    deleteSampleStats(params) {
        return this._delete("analysis", null, "variant/sample/stats", null, "delete", params);
    }
    ...
    */
    infoSampleStats(sample, params) {
        return this._get("analysis", null, "variant/sample/stats", null, "info", {sample, ...params});
    }
