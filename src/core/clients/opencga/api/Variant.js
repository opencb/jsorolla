...
export default class Variant extends OpenCGAParentClass {
    ...
    * @param {String} [params.biotype] - Filter by transcript biotype.
    * @param {String} [params.variants] - Filter by variant id.
    * @param {String} [params.knockout] - Filter by knockout type.
    * @param {String} [params.filter] - Filter by filter (PASS, NOT_PASS).
    * @param {String} [params.populatioFrequency] - Filter by population frequency.
    * @param {String} [params.consequenceType] - Filter by consequence type.
    * @param {String} [params.study] - Filter variants from the given studies, these can be either the numeric ID or the alias with the
    *     format user@project:study.
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    individualQuery(params) {
        return this._get("analysis", null, "variant", null, "individualQuery", params);
    }
