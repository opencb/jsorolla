 ...
 * Autogenerated on: 2020-07-27 16:11:58
 * 
...
export default class Variant extends OpenCGAParentClass {
    ...
    *     number of points to display), the set of general filters and the list of tracks. Currently, the supported track types are: COPY-
    *     NUMBER, INDEL, REARRANGEMENT and SNV. In addition, each track allows users to define its own set of filters.
    * @param {Object} [params] - The Object containing the following optional parameters:
