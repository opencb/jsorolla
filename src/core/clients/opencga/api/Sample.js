 ...
 * Autogenerated on: 2021-01-18 16:35:13
 * 
...
export default class Sample extends OpenCGAParentClass {
    ...
    * @param {Boolean} [params.propagate = "false"] - Propagate sample permissions to related individuals. The default value is false.
    ...
    * @param {String} [params.individualId] - Individual ID.
    * @param {String} [params.fileIds] - Comma separated list of file IDs.
    ...
    * @param {String} [params.stats.id] - Sample variant stats id. If filtering by other stats fields and not provided, it will be
    *     automatically set to ALL.
    * @param {String} [params.stats.variantCount] - Sample variant stats variantCount.
    * @param {String} [params.stats.chromosomeCount] - Sample variant stats chromosomeCount.
    * @param {String} [params.stats.typeCount] - Sample variant stats typeCount.
    * @param {String} [params.stats.genotypeCount] - Sample variant stats genotypeCount.
    * @param {String} [params.stats.tiTvRatio] - Sample variant stats tiTvRatio.
    * @param {String} [params.stats.qualityAvg] - Sample variant stats qualityAvg.
    * @param {String} [params.stats.qualityStdDev] - Sample variant stats qualityStdDev.
    * @param {String} [params.stats.heterozygosityRate] - Sample variant stats heterozygosityRate.
    * @param {String} [params.stats.depthCount] - Sample variant stats depthCount.
    * @param {String} [params.stats.biotypeCount] - Sample variant stats biotypeCount.
    * @param {String} [params.stats.clinicalSignificanceCount] - Sample variant stats clinicalSignificanceCount.
    * @param {String} [params.stats.consequenceTypeCount] - Sample variant stats consequenceTypeCount.
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    search(params) {
