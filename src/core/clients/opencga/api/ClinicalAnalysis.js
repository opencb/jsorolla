...
export default class ClinicalAnalysis extends OpenCGAParentClass {
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runPipelineGenomics(data, params) {
        return this._post("analysis", null, "clinical/pipeline/genomics", null, "run", data, params);
    }

    /** Prepare the clinical pipeline.
    * @param {Object} data - JSON with parameters to execute the command ngs-pipeline-prepare.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - study.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runPipelinePrepare(data, params) {
        return this._post("analysis", null, "clinical/pipeline/prepare", null, "run", data, params);
    }
