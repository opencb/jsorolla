 ...
 * Autogenerated on: 2020-05-08 23:44:44
 * 
...
export default class Clinical extends OpenCGAParentClass {
    ...
    */
    searchInterpretation(params) {
        return this._get("analysis/clinical", null, "interpretation", null, "search", params);
    }
    ...
    */
    runInterpreterCancerTiering(data, params) {
        return this._post("analysis/clinical", null, "interpreter/cancerTiering", null, "run", data, params);
    }
    ...
    */
    runInterpreterTeam(data, params) {
        return this._post("analysis/clinical", null, "interpreter/team", null, "run", data, params);
    }
    ...
    */
    runInterpreterTiering(data, params) {
        return this._post("analysis/clinical", null, "interpreter/tiering", null, "run", data, params);
    }
    ...
    */
    runInterpreterZetta(data, params) {
        return this._post("analysis/clinical", null, "interpreter/zetta", null, "run", data, params);
    }
    ...
    * @param {String} [params.description] - Description.
    * @param {String} [params.family] - Family.
    * @param {String} [params.proband] - Proband.
    ...
    */
    actionableVariant(params) {
        return this._get("analysis/clinical", null, "variant", null, "actionable", params);
    }
    ...
    *     e.g.: >123.4.
    * @param {String} [params.fileData] - Filter by file data (i.e. INFO column from VCF file). [{file}:]{key}{op}{value}[,;]* . If no file
    *     is specified, will use all files from "file" filter. e.g. AN>200 or file_1.vcf:AN>200;file_2.vcf:AN<10 . Many INFO fields can be
    ...
    *     segregation modes: [ monoallelic, monoallelicIncompletePenetrance, biallelic, biallelicIncompletePenetrance, XlinkedBiallelic,
    *     XlinkedMonoallelic, Ylinked, MendelianError, DeNovo, CompoundHeterozygous ]. Value is case insensitive. e.g. HG0097:DeNovo Sample must
    *     have parents defined and indexed. .
    ...
    * @param {String} [params.familySegregation] - Filter by segregation mode from a given family. Accepted values: [ monoallelic,
    ...
    */
    delete(clinicalAnalyses, params) {
        return this._delete("analysis/clinical", clinicalAnalyses, null, null, "delete", params);
    }
    ...
    */
    info(clinicalAnalysis, params) {
        return this._get("analysis/clinical", clinicalAnalysis, null, null, "info", params);
    }
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    updateInterpretation(clinicalAnalysis, data, params) {
        return this._post("analysis/clinical", clinicalAnalysis, "interpretation", null, "update", data, params);
    }
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    updateSecondaryInterpretations(clinicalAnalysis, data, params) {
        return this._post("analysis/clinical", clinicalAnalysis, "secondaryInterpretations", null, "update", data, params);
    }
