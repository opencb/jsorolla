...
export default class Clinical extends OpenCGAParentClass {
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runInterpretationCancerTiering(data, params) {
        return this._post("analysis/clinical", null, "interpretation/cancerTiering", null, "run", data, params);
    }
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runInterpretationTeam(data, params) {
        return this._post("analysis/clinical", null, "interpretation/team", null, "run", data, params);
    }
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runInterpretationTiering(data, params) {
        return this._post("analysis/clinical", null, "interpretation/tiering", null, "run", data, params);
    }
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runInterpretationZetta(data, params) {
        return this._post("analysis/clinical", null, "interpretation/zetta", null, "run", data, params);
    }
