...
export default class OpencgaClinicalAnalysisFacet extends LitElement {
    ...
    //TODO this component will be the new opencga-clinical-analysis-browser and this configuration will be for browser and facet both
    getDefaultConfig() {
        return {
...
customElements.define("opencga-clinical-analysis-facet", OpencgaClinicalAnalysisFacet);
