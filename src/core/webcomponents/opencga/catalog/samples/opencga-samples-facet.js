...
export default class OpencgaSamplesFacet extends LitElement {
    ...
    getDefaultConfig() {
        ...
        return {
            title: "Aggregation Stats for Sample",
...
customElements.define("opencga-samples-facet", OpencgaSamplesFacet);
