...
export default class OpencgaIndividualFacet extends LitElement {
    ...
    getDefaultConfig() {
        ...
        return {
            title: "Aggregation Stats for Individuals",
            name: "Aggregation for Individuals",
            active: false,
...
customElements.define("opencga-individual-facet", OpencgaIndividualFacet);
