...
export default class OpencgaDateFilterLit extends LitElement {
    ...
    connectedCallback() {
        ...
        //this.months = {"Jan": 30, "Feb": 28, "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
...
customElements.define("opencga-date-filter", OpencgaDateFilterLit);
