...
//                    baseColorHex:0x000000, topColorHex:0xFF0000, histogramType:Viewer.Features.ColumnHistogram});
                ...
                torus.viewer.disk[i].features[0].addFeature({start:0, end:end, z:0.5, data:data, mod:-1/5, ang:0,
                    baseColorHex:0x0000FF, topColorHex:0xFF0000, histogramType:Viewer.Features.ColumnHistogram});
                torus.viewer.disk[i].features[0].addFeature({start:0, end:end, z:0.5, data:data, mod:+1/5, ang:0,
                    baseColorHex:0x0000FF, topColorHex:0xFF00, histogramType:Viewer.Features.LinearHistogram});

                torus.viewer.disk[i].features[0].addFeature({start:0, end:end, z:1, data:data2, mod:-1/5, ang:0,
                    baseColorHex:0xFF0000, topColorHex:0xFF0000, histogramType:Viewer.Features.ColumnHistogram});
                torus.viewer.disk[i].features[0].addFeature({start:0, end:end, z:0, data:data3, mod:+1/5, ang:0,
                    baseColorHex:0xAAFF00, topColorHex:0x8800, histogramType:Viewer.Features.LinearHistogram});

                torus.viewer.disk[i].features[0].addFeature({start:0, end:1, y:-0.02, z:0.5, data:data4, mod:+1/3, ang:-Math.PI/2,
                    baseColorHex:0x0000FF, topColorHex:0xFF00, histogramType:Viewer.Features.LinearHistogram});
                ...
                for(j = 0; j < 100; j++){
                    ...
                    var m = 0.07;
                    var l = 0.02;
                    torus.viewer.disk[i].features[0].addFeature({start:s, end:s+Math.random()*l, z:Math.random()*(1-m), mod:m, ang:0,
                ...
                for(j = 0; j < 100; j++){
                    ...
                    var m = 0.07;
                    var l = 0.02;
                    torus.viewer.disk[i].features[0].addFeature({start:s, end:s+Math.random()*l, z:0.45, mod:m, ang:+Math.PI/2,
                        baseColorHex:0xA00000, topColorHex:0xA00000, y : Math.random()*(1-m)});
                }


                torus.viewer.disk[i].features[0].addFeature({start:end2, end:4, z:0.5, data:data5, mod:1.2, ang:+Math.PI/2,
                    baseColorHex:0xAAAAAA, topColorHex:0xDDDDDD, histogramType:Viewer.Features.LinearHistogram});
