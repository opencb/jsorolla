...
export default class File {
     ...
     * @param {Object} [params] - The Object containing the following optional parameters:
     * @param {String} [params.study] - Study [[user@]project:]study where study and project can be either the ID or UUID.
     * @param {String} [params.id] - Comma separated list of file IDs up to a maximum of 100.
     ...
     * @param {String} [params.uri] - Comma separated list of uris.
     ...
     *     JSON AVRO PARQUET IMAGE PLAIN BINARY NONE UNKNOWN"} [params.fileFormat] - File format.
