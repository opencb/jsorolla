                    ...
                    <div class="row facet-row number-field">
                        <div class="col-md-8">
                            <div class="row facet-row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="Stop" id="${this._prefix}${facet.id}_range_stop" .disabled="${facet.fn}" data-id="${facet.id}" data-type="range_stop" .value="${nstop || ""}" @input="${this.onFacetRangeChange}" />
                                </div>
                                <div class="col-md-4">
                            ...
                            <!--<input type="text" class="forms-control" placeholder="Include values or set range" id="${this._prefix}${facet.id}_text" data-id="${facet.id}" .value="${num_value || ""}" @input="${this.onFacetValueChange}" />-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row facet-row number-field">
                        <div class="col-md-8">
                            <div class="row facet-row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="Stop" data-parent-facet="${parent}" id="${this._prefix}${parent}_Nested_range_stop" .disabled="${facet.fn}" data-id="${facet.id}" data-type="range_stop" .value="${nstop || ""}" @input="${this.onNestedFacetRangeChange}" />
                                </div>
                                <div class="col-md-4">
                            ...
                            <!--<input type="text" class="forms-control" placeholder="Include values or set range" data-parent-facet="${parent}" .disabled="${!(facet.facet)}" id="${this._prefix}${parent}_NestedValue" .value="${num_value || ""}"  @input="${this.onNestedFacetValueChange}"  />-->
                        </div>
                        <div class="col-md-4">
