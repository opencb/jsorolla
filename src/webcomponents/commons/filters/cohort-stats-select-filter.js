...
export default class CohortStatsSelectFilter extends LitElement {
    ...
    render() {
        ...
        return html`
             ${this.cohorts.map(study => html`
                 <div class="cohort-stats-select-filter">
                     <Label> Study <b>${study.id}</b> cohorts:</Label>
                     <select-field-filter
                         .data="${this.options}"
                         .value="${this.opencgaSession?.study.cohorts || []}"
        ...
        return html`
            ...
            <div class="mb-3">
                ${this._config.alias && this._config.alias.length > 0 ? html`
                    <label class="form-label">Favourite cohorts:</label>
            ...
            <div class="mb-3">
                <label class="form-label">Select cohorts:</label>
                <select-field-filter
                    .data="${this.options}"
                    .value="${this.opencgaSession?.study.cohorts || []}"
                    .config="${{multiple: true}}"
