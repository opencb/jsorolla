...
//    var middle = this.width / 2;
    ...
    var aligCoverGroup = SVG.addChild(args.svgCanvasFeatures, "g", {
        "class": "aligCoverage",
        "cursor": "pointer"
    });
    var aligReadGroup = SVG.addChild(args.svgCanvasFeatures, "g", {
        "class": "aligReads",
        "cursor": "pointer"
    });
...
//            lineAll += xx + "," + coverageList[i] / coverageNorm * covHeight + " ";
        ...
        var polC = SVG.addChild(aligCoverGroup, "polyline", {
            "points": lineA + " " + rlineC,
            //"opacity":"1",
            //"stroke-width":"1",
            //"stroke":"black",
        ...
        var polG = SVG.addChild(aligCoverGroup, "polyline", {
            "points": lineC + " " + rlineG,
            //"opacity":"1",
            //"stroke-width":"1",
            //"stroke":"black",
        ...
        var polT = SVG.addChild(aligCoverGroup, "polyline", {
            "points": lineG + " " + rlineT,
            //"opacity":"1",
            //"stroke-width":"1",
            //"stroke":"black",
...
//		var textY = 12+settings.height;
        while (true) {
            ...
            if (enc) {
                var featureGroup = SVG.addChild(aligReadGroup, "g", {'feature_id': feature.name});
                var points = {
...
//		var textY = 12+settings.height;
        ...
        while (true) {
            ...
            if (enc) {
                ...
                var readPoly = SVG.addChild(aligReadGroup, "polygon", {
                ...
                var matePoly = SVG.addChild(aligReadGroup, "polygon", {
                ...
                var line = SVG.addChild(aligReadGroup, "line", {
                    "x1": (readX + readWidth),
                ...
                if (args.regionSize < 400) {
                    if (readDiff != null) {
                        var readPath = SVG.addChild(aligReadGroup, "path", {
                    ...
                    if (mateDiff != null) {
                        var matePath = SVG.addChild(aligReadGroup, "path", {
