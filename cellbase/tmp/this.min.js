...
this.getSingle=function(b,a,d,e,f,g){this.category=b;this.subcategory=a;this.query=d;this.resource=e;this._callServer(this.getUrl(),f,g)};this.getMultiple=function(b,a,d,e){var f=[];if(d.length>this.maxQuery)for(var g=0;g<d.length;g+=this.maxQuery)f.push(d.slice(g,g+this.maxQuery));this.numberQueries=f.length;var h=this;this.batchSuccessed.addEventListener(function(b,a){h._joinToResults(a)});for(g=0;g<f.length;g++)this.results.push([]),this.getSingle(b,a,f[g].toString(),e,g)};this._callServer=function(b,
a,d){var e=this;$.ajax({url:b,type:"GET",async:this.async,data:{contentformat:this.contentformat,outputcompress:this.outputcompress,callbackParam:"response"},dataType:this.dataType,jsonp:"callback",success:function(){"undefined"!=typeof response?(null!=d&&d(response),e.batching?e.batchSuccessed.notify({data:response,id:a}):e.successed.notify(response)):e.error.notify()},complete:function(){e.completed.notify()},error:function(){e.error.notify()}})}};GeneRegionCellBaseDataAdapter.prototype.setVersion=RegionCellBaseDataAdapter.prototype.setVersion;GeneRegionCellBaseDataAdapter.prototype.setSpecies=RegionCellBaseDataAdapter.prototype.setSpecies;GeneRegionCellBaseDataAdapter.prototype.toJSON=RegionCellBaseDataAdapter.prototype.toJSON;GeneRegionCellBaseDataAdapter.prototype.setIntervalView=RegionCellBaseDataAdapter.prototype.setIntervalView;GeneRegionCellBaseDataAdapter.prototype.getFinished=RegionCellBaseDataAdapter.prototype.getFinished;
...
XrefFeatureListCellBaseDataAdapter.prototype.fill=function(a,b){this.resource+=this.arrayToString(this.databases,",");null!=b&&(a+="&identifier="+b);this.cellBaseManager.get(this.category,this.subcategory,a,this.resource);var c=this;this.cellBaseManager.successed.addEventListener(function(b,a){c.getFinished(a)})};FeatureListCellBaseDataAdapter.prototype.setVersion=CellBaseDataAdapter.prototype.setVersion;FeatureListCellBaseDataAdapter.prototype.setSpecies=CellBaseDataAdapter.prototype.setSpecies;FeatureListCellBaseDataAdapter.prototype.getVersion=CellBaseDataAdapter.prototype.getVersion;FeatureListCellBaseDataAdapter.prototype.getSpecies=CellBaseDataAdapter.prototype.getSpecies;FeatureListCellBaseDataAdapter.prototype.getFinished=CellBaseDataAdapter.prototype.getFinished;
FeatureListCellBaseDataAdapter.prototype.toJSON=CellBaseDataAdapter.prototype.toJSON;function FeatureListCellBaseDataAdapter(a){CellBaseDataAdapter.prototype.constructor.call(this,a);this.category="feature";this.subcategory=null;this.resource="info"}FeatureListCellBaseDataAdapter.prototype.fill=function(a,b){this.cellBaseManager.get(this.category,a,b,this.resource);var c=this;this.cellBaseManager.successed.addEventListener(function(b,a){c.getFinished(a)})};RegionCellBaseDataAdapter.prototype.setVersion=CellBaseDataAdapter.prototype.setVersion;RegionCellBaseDataAdapter.prototype.setSpecies=CellBaseDataAdapter.prototype.setSpecies;RegionCellBaseDataAdapter.prototype.toJSON=CellBaseDataAdapter.prototype.toJSON;
...
b.stopAnimation=ChemDoodle._AnimatorCanvas.prototype.stopAnimation,b.isRunning=ChemDoodle._AnimatorCanvas.prototype.isRunning,b.dblclick=ChemDoodle.RotatorCanvas.prototype.dblclick,b.nextFrame=function(b){var a=[];mat4.identity(a);var b=b/1E3,c=Math.PI/15;mat4.rotate(a,c*b,[1,0,0]);mat4.rotate(a,c*b,[0,1,0]);mat4.rotate(a,c*b,[0,0,1]);mat4.multiply(this.rotationMatrix,a)},$.get("http://www.rcsb.org/pdb/files/"+a+".pdb",function(a){a=ChemDoodle.readPDB(a);b.loadMolecule(a);b.startAnimation()})):(b.emptyMessage=
...
TranscriptInfoWidget.prototype.dataReceived=function(a){this.data=a[0];this.optionClick({text:"Information",leaf:"true"});this.panel.enable();this.panel.setLoading(!1)};function InfoWidget(a,b,c){this.id="InfoWidget_"+Math.round(1E7*Math.random());this.targetId=null;this.species=b;console.log(this.species);this.featureId=this.title=null;this.width=800;this.height=400;null!=a&&(this.targetId=a);null!=c&&(null!=c.title&&(this.title=c.title),null!=c.width&&(this.width=c.width),null!=c.height&&(this.height=c.height));switch(b){case "hsa":this.ensemblSpecie="Homo_sapiens";this.reactomeSpecie="48887";this.wikipathwaysSpecie="Homo+sapiens";this.haphapSpecie=this.dbsnpSpecie=
...
a.stopAnimation=ChemDoodle._AnimatorCanvas.prototype.stopAnimation,a.isRunning=ChemDoodle._AnimatorCanvas.prototype.isRunning,a.dblclick=ChemDoodle.RotatorCanvas.prototype.dblclick,a.nextFrame=function(a){var b=[];mat4.identity(b);var a=a/1E3,c=Math.PI/15;mat4.rotate(b,c*a,[1,0,0]);mat4.rotate(b,c*a,[0,1,0]);mat4.rotate(b,c*a,[0,0,1]);mat4.multiply(this.rotationMatrix,b)},$.get("http://www.rcsb.org/pdb/files/"+b+".pdb",function(b){b=ChemDoodle.readPDB(b);a.loadMolecule(b);a.startAnimation()})):(a.emptyMessage=
...
SnpInfoWidget.prototype.dataReceived=function(a){for(var a=a[0],b=0;b<a.length;b++)a[b].chromosome==this.feature.feature.chromosome&&a[b].start==this.feature.start&&a[b].end==this.feature.end&&(this.data=a[b],console.log(a[b]));this.optionClick({text:"Information",leaf:"true"});this.panel.enable();this.panel.setLoading(!1)};TFInfoWidget.prototype.draw=InfoWidget.prototype.draw;TFInfoWidget.prototype.render=InfoWidget.prototype.render;TFInfoWidget.prototype.getTreePanel=InfoWidget.prototype.getTreePanel;TFInfoWidget.prototype.checkDataTypes=InfoWidget.prototype.checkDataTypes;TFInfoWidget.prototype.doGrid=InfoWidget.prototype.doGrid;TFInfoWidget.prototype.getTranscriptTemplate=InfoWidget.prototype.getTranscriptTemplate;
function TFInfoWidget(a,b,c){null==c&&(c={});c.title="Transcription Factor Info";InfoWidget.prototype.constructor.call(this,a,b,c)}TFInfoWidget.prototype.getdataTypes=function(){return dataTypes=[{text:"Information",children:[{text:"Protein"},{text:"Transcript"},{text:"Gene"}]},{text:"Regulatory",children:[{text:"PWM"},{text:"Target Genes"}]}]};TFInfoWidget.prototype.optionClick=function(a){a.leaf&&null!=this.panel.getComponent(1)&&(this.panel.getComponent(1).hide(),this.panel.remove(1,!1))};
...
VCFVariantInfoWidget.prototype.dataReceived=function(a){this.data=a.feature;this.optionClick({text:"Information",leaf:"true"});this.panel.enable();this.panel.setLoading(!1)};
