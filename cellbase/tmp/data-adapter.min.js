...
VCFFileDataAdapter.prototype.parse=function(a){this.content=a;for(var a=a.split("\n"),b=0;b<a.length;b++){var c=a[b].replace(/^\s+|\s+$/g,"");null!=c&&0<c.length&&(c=c.replace(/\t/g,"**%**").split("**%**"),"#"!=c[0].substr(0,1)&&this.lines.push(c))}};SIFFileDataAdapter.prototype.loadFromFile=FileDataAdapter.prototype.loadFromFile;SIFFileDataAdapter.prototype.loadFromContent=FileDataAdapter.prototype.loadFromContent;function SIFFileDataAdapter(){FileDataAdapter.prototype.constructor.call(this);this.dataset=new GraphDataset;this.graph={};this.graph.edges=[];this.graph.nodes=[];this.graph.relations=[]}
SIFFileDataAdapter.prototype.toSIFID=function(a){var b="",c;for(c in a.vertices){var d="",d=a.getVertexById(c);if(0==d.getEdges().length)d=d.getId()+"\n",b+=d;else for(var e=d.getEdgesOut(),g=0;g<e.length;g++)d=e[g].getNodeSource().getId()+"\t--\t"+e[g].getNodeTarget().getId()+"\n",b+=d}return b};
...
TabularFileDataAdapter.prototype.parse=function(a){this.content=a;for(var a=a.split("\n"),b=0;b<a.length;b++){var c=a[b].replace(/^\s+|\s+$/g,""),c=c.replace(/\//gi,"");if(null!=c&&0<c.length){var d=c.replace(/\t/g,"**%**").split("**%**");null==this.comment?this.lines.push(d):"#"!=c.substring(0,1)&&this.lines.push(d)}}};GFFFileDataAdapter.prototype.loadFromFile=FileDataAdapter.prototype.loadFromFile;GFFFileDataAdapter.prototype.loadFromContent=FileDataAdapter.prototype.loadFromContent;GFFFileDataAdapter.prototype.read=FileDataAdapter.prototype.read;GFFFileDataAdapter.prototype.getDataset=FileDataAdapter.prototype.getDataset;function GFFFileDataAdapter(){FileDataAdapter.prototype.constructor.call(this);this.content=this.dataset=null;this.lines=[]}GFFFileDataAdapter.prototype.getLines=function(){return this.lines};
GFFFileDataAdapter.prototype.parse=function(a){this.content=a;for(var a=a.split("\n"),b=0;b<a.length;b++){var c=a[b].replace(/^\s+|\s+$/g,"");null!=c&&0<c.length&&(c=c.replace(/\t/g,"**%**").split("**%**"),"#"!=c[0].substr(0,1)&&this.lines.push(c))}};DotFileDataAdapter.prototype.loadFromFile=FileDataAdapter.prototype.loadFromFile;DotFileDataAdapter.prototype.loadFromContent=FileDataAdapter.prototype.loadFromContent;DotFileDataAdapter.prototype.getDataset=FileDataAdapter.prototype.getDataset;function DotFileDataAdapter(){FileDataAdapter.prototype.constructor.call(this);this.dataset=new GraphDataset}
DotFileDataAdapter.prototype._toSIFID=function(a){var b="",c;for(c in a.vertices){var d="",d=a.getVertexById(c);if(0==d.getEdges().length)d=d.getId()+"\n",b+=d;else for(var e=d.getEdgesOut(),g=0;g<e.length;g++)d=e[g].getNodeSource().getId()+" -- "+e[g].getNodeTarget().getId()+"\n",b+=d}return b};
...
c=this.dataset.getVertexByName(d[b[i].target].label),this.dataset.addEdge(a.getId()+"_"+c.getId(),a.getId(),c.getId(),b[i].args);for(l in this.dataset.vertices){for(k=this.dataset.getVertexById(l).getName();-1!=k.indexOf('"');)k=k.replace('"',"");this.dataset.getVertexById(l).setName(k)}};InteractomeDotFileDataAdapter.prototype.loadFromFile=DotFileDataAdapter.prototype.loadFromFile;InteractomeDotFileDataAdapter.prototype.loadFromContent=DotFileDataAdapter.prototype.loadFromContent;InteractomeDotFileDataAdapter.prototype.nodeAttributesToJSON=DotFileDataAdapter.prototype.nodeAttributesToJSON;InteractomeDotFileDataAdapter.prototype.parse=DotFileDataAdapter.prototype.parse;InteractomeDotFileDataAdapter.prototype.getDataset=DotFileDataAdapter.prototype.getDataset;
InteractomeDotFileDataAdapter.prototype.parseLines=DotFileDataAdapter.prototype.parseLines;function InteractomeDotFileDataAdapter(){DotFileDataAdapter.prototype.constructor.call(this);this.dataset=new InteractomeGraphDataset;this.layout=new LayoutDataset}
...
"odot"==d.arrowhead&&this.formatter.changeEdgeType(e,"OdotDirectedLineEdgeNetworkFormatter"),null!=d.opacity&&this.formatter.getEdgeById(e).getDefault().setStrokeOpacity(d.opacity),null!=d.size&&this.formatter.getEdgeById(e).getDefault().setSize(d.size);return this.formatter};InteractomeDotFileDataAdapter.prototype.getLayout=function(){this.layout.dataBind(this.dataset);return this.layout};BiopaxDotFileDataAdapter.prototype.loadFromFile=DotFileDataAdapter.prototype.loadFromFile;BiopaxDotFileDataAdapter.prototype.loadFromContent=DotFileDataAdapter.prototype.loadFromContent;BiopaxDotFileDataAdapter.prototype.nodeAttributesToJSON=DotFileDataAdapter.prototype.nodeAttributesToJSON;BiopaxDotFileDataAdapter.prototype.parse=DotFileDataAdapter.prototype.parse;BiopaxDotFileDataAdapter.prototype.getDataset=DotFileDataAdapter.prototype.getDataset;
BiopaxDotFileDataAdapter.prototype.parseFromJSON=DotFileDataAdapter.prototype.parseFromJSON;BiopaxDotFileDataAdapter.prototype.parseLines=DotFileDataAdapter.prototype.parseLines;
