...
function GeneFeatureDataSet(){FeatureDataAdapter.prototype.constructor.call(this)}GeneFeatureDataSet.prototype=FeatureDataAdapter;GeneFeatureDataSet.prototype.constructor=FeatureDataAdapter;GeneFeatureDataSet.prototype.loadFromJSON=FeatureDataAdapter.prototype.loadFromJSON;GeneFeatureDataSet.prototype.loadFromFile=FeatureDataAdapter.prototype.loadFromFile;GeneFeatureDataSet.prototype.loadFromURL=FeatureDataAdapter.prototype.loadFromURL;GeneFeatureDataSet.prototype.toJSON=FeatureDataAdapter.prototype.toJSON;
GeneFeatureDataSet.prototype.validate=FeatureDataAdapter.prototype.validate;function ExpressionMatrixDataSet(){DataSet.prototype.constructor.call(this);this.normalizedRows={};this.colorRows={};this.classesName=null;this._classMaxInterval={};this._classMinInterval={};this._json=null;this.groupByClass=!0}ExpressionMatrixDataSet.prototype.toJSON=DataSet.prototype.toJSON;
ExpressionMatrixDataSet.prototype.loadFromJSON=function(a){this.validate(a)&&(this.json=a,this._json=JSON.parse(JSON.stringify(a)),this.init())};ExpressionMatrixDataSet.prototype.getRowNameByStatisticValue=function(a,b,c){for(var a=this.getRowIndexByStatisticValue(a,b,c),b=this.getRowNames(),c=[],d=0;d<a.length;d++)c.push(b[a[d]]);return c};
ExpressionMatrixDataSet.prototype.getRowIndexByStatisticValue=function(a,b,c){for(var d=this.getStatisticNames(),e=0;e<d.length;e++)if(d[e]==a){for(var a=[],d=this.getStatisticMatrix(),f=0;f<d.length;f++)d[f][e]>=b&&d[f][e]<=c&&a.push(f);return a}};ExpressionMatrixDataSet.prototype.init=function(){this.normalizedRows={};this.colorRows={};this.classesName=null;this._classMaxInterval={};this._classMinInterval={};this.normalizeMatrix()};ExpressionMatrixDataSet.prototype.validate=function(){return!0};
ExpressionMatrixDataSet.prototype.getStatisticNames=function(){return this.json.statisticMatrix.columnNames};ExpressionMatrixDataSet.prototype.getStatisticMatrix=function(){return this.json.statisticMatrix.matrix};ExpressionMatrixDataSet.prototype.getRowNames=function(){return this.json.dataMatrix.rowNames};ExpressionMatrixDataSet.prototype.getColumnNames=function(){return this.json.dataMatrix.columnNames};ExpressionMatrixDataSet.prototype.getMatrix=function(){return this.json.dataMatrix.matrix};
ExpressionMatrixDataSet.prototype.getClasses=function(){return this.json.classNames};ExpressionMatrixDataSet.prototype.getClassesName=function(){if(null==this.classesName){var a=this.getClasses(),b=[];b.push(a[0]);this._classMinInterval[0]=0;for(var c=1;c<a.length;c++)a[c]!=b[b.length-1]&&(b.push(a[c]),this._classMaxInterval[b.length-2]=c-1,this._classMinInterval[b.length-1]=c);this._classMaxInterval[b.length-1]=a.length-1;this.classesName=b}return this.classesName};
