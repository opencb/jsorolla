...
context("5. Variant Browser", () => {
    ...
    it("5.1 Columns Visibility", () => {
        ...
        utils.checkColumnsGridBrowser("variant-browser-grid");
        ...
        utils.clickAllColumnsGridBrowser("variant-browser-grid");

        // testing the first level of the header
        utils.checkHeaderGridBrowser("variant-browser-grid").should("have.lengthOf", 6);

        // reactivate all the columns
        utils.clickAllColumnsGridBrowser("variant-browser-grid");
        utils.checkHeaderGridBrowser("variant-browser-grid").should("have.lengthOf", 10);
