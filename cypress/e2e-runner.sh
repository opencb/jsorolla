...
do
  ...
  CYPRESS_study="$study" npx cypress run  --config-file="cypress/cypress.config.js" --config videosFolder="cypress/videos/$study",screenshotsFolder="cypress/screenshots/$study" --headless --spec 'cypress/integration/*';  \
