...
(function(){function a(a){return 10>a?"0"+a:a}function b(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=i[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(a,d){var e,i,p,r,l=f,o,m=d[a];m&&"object"===typeof m&&"function"===typeof m.toJSON&&(m=m.toJSON(a));"function"===typeof h&&(m=h.call(d,a,m));switch(typeof m){case "string":return b(m);case "number":return isFinite(m)?""+m:"null";case "boolean":case "null":return""+
m;case "object":if(!m)return"null";f+=g;o=[];if("[object Array]"===Object.prototype.toString.apply(m)){r=m.length;for(e=0;e<r;e+=1)o[e]=c(e,m)||"null";p=0===o.length?"[]":f?"[\n"+f+o.join(",\n"+f)+"\n"+l+"]":"["+o.join(",")+"]";f=l;return p}if(h&&"object"===typeof h){r=h.length;for(e=0;e<r;e+=1)i=h[e],"string"===typeof i&&(p=c(i,m))&&o.push(b(i)+(f?": ":":")+p)}else for(i in m)Object.hasOwnProperty.call(m,i)&&(p=c(i,m))&&o.push(b(i)+(f?": ":":")+p);p=0===o.length?"{}":f?"{\n"+f+o.join(",\n"+f)+"\n"+
l+"}":"{"+o.join(",")+"}";f=l;return p}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var d=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
e=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,f,g,i={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},h;"function"!==typeof JSON.stringify&&(JSON.stringify=function(a,b,d){var e;g=f="";if("number"===typeof d)for(e=0;e<d;e+=1)g+=" ";else"string"===typeof d&&(g=d);if((h=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return c("",
...
function renderFeeds(a){var b=new StringBuffer,c=[],d=[];if(null!=FEED_OBJECT&&0<FEED_OBJECT.length){for(var e=0;e<FEED_OBJECT.length;e++)for(var f=FEED_OBJECT[e],g=0;g<f.entries.length;g++){var i=f.entries[g];d[i.title]||(d[i.title]=!0,c=c.concat(f.entries[g]))}b.appendln("<div>&nbsp;</div>");b.appendln("<div>&nbsp;</div>");b.appendln("<div>&nbsp;</div>");b.append("<span class='references-title'>References</span>");b.append("<ul>");for(g=0;g<c.length;g++){i=c[g];b.append("<li>");b.append("<span>"+
i.author+". </span>");b.append("<span class='feed-content'><a href='"+i.link+"'  target='_blank'> "+i.title+"</a></span>");b.append("<span>"+i.categories+"</span>");d=i.content.split("<a");for(e=0;e<d.length;e++)f=d[e].lastIndexOf("</a>"),d[e]=d[e].substring(0,f);b.append("<div class='feed-link'><a class='text-show feed-link'>...see PubMed links</a>");b.append("\t<span class='text-hide feed-content'>");for(e=0;e<d.length;e++)null!=d[e]&&""!=d[e]&&(b.append("<a target='_blank'"),b.append(d[e]),b.append("</a>"));
...
Math.sha1Hash=function(a){for(var b=[1518500249,1859775393,2400959708,3395469782],a=a+String.fromCharCode(128),c=Math.ceil((a.length/4+2)/16),d=Array(c),e=0;e<c;e++){d[e]=Array(16);for(var f=0;16>f;f++)d[e][f]=a.charCodeAt(64*e+4*f)<<24|a.charCodeAt(64*e+4*f+1)<<16|a.charCodeAt(64*e+4*f+2)<<8|a.charCodeAt(64*e+4*f+3)}d[c-1][14]=8*(a.length-1)/Math.pow(2,32);d[c-1][14]=Math.floor(d[c-1][14]);d[c-1][15]=8*(a.length-1)&4294967295;for(var a=1732584193,f=4023233417,g=2562383102,i=271733878,h=3285377520,
k=Array(80),n,s,q,p,r,e=0;e<c;e++){for(var l=0;16>l;l++)k[l]=d[e][l];for(l=16;80>l;l++)k[l]=Math.ROTL(k[l-3]^k[l-8]^k[l-14]^k[l-16],1);n=a;s=f;q=g;p=i;r=h;for(l=0;80>l;l++){var o=Math.floor(l/20),o=Math.ROTL(n,5)+Math.f(o,s,q,p)+r+b[o]+k[l]&4294967295;r=p;p=q;q=Math.ROTL(s,30);s=n;n=o}a=a+n&4294967295;f=f+s&4294967295;g=g+q&4294967295;i=i+p&4294967295;h=h+r&4294967295}return a.toHexStr()+f.toHexStr()+g.toHexStr()+i.toHexStr()+h.toHexStr()};
...
this.width)];this.draw()},getModel:function(){return this._model},addNode:function(a,b,c,d,e,f,g,i,h,k){var n=[],s=[];n.push(c);s.push(d);var q=[];q.push(c);q.push(d);c=new PlotNode(a,b,n,s,[],{color:e,size:i,opacity:g,shape:h,nodeStrokeWidth:k});d=this._model.getNodes();this._model.getNodesId()[a]=d.length;d.push(c);this._coordenates[a]=q;this._color[a]=e;this._visible[a]=f;this._opacity[a]=g;this._size[a]=i;this._shape[a]=h;this._nodeStrokeWidth[a]=k;this._deletedNodes[a]=!1;this._id_title[a]=b;
...
function(){for(var a=0;a<this.sifFieldsString.length;a++){var c=this.sifFieldsString[a][0],d=this._calculateCoordenates(a,c,!0);this.nodes.push(d);this.nodesId[c]=a;this.nodeLevel[c]=0}for(a=0;a<this.sifFieldsString.length;a++)for(c=2;c<this.sifFieldsString[a].length;c++){var d=this.sifFieldsString[a][0],e=this.sifFieldsString[a][c],f="edge_"+d+"_"+e;this.addEdge(a,f);var g=this.classes[d],i=this.classes[e];this.edges.push(new PlotEdge(f,d,e,{type:this.edgeType,area:this.getEdgeLocation(g,i),classesNumber:3,
opacity:0.5}));this.edgesId[f]=this.edges.length-1;this.classes[d]!=this.classes[e]?(this.nodeLevel[d]++,this.nodeLevel[e]++,this.maxLevelPerClass[g]<this.nodeLevel[d]&&(this.maxLevelPerClass[g]=this.nodeLevel[d]),this.maxLevelPerClass[i]<this.nodeLevel[e]&&(this.maxLevelPerClass[i]=this.nodeLevel[e])):this.edges.pop()}for(a=0;a<this.sifFieldsString.length;a++)c=this.sifFieldsString[a][0],this.nodeLevelSorter.push([this.nodeLevel[c],c]);this.nodeLevelSorter.reverse().sort();this.nodes=[];for(a=0;a<
...
function randomSIF(a,b){for(var c="",d="",e="",f=0;f<a;f++){var c=c+"node_"+f+" type_"+f+" ",d=d+"node_"+f+" type_"+f+" ",e=e+"node_"+f+" type_"+f+" ",g=Math.ceil(Math.random()*(a/100));if(0==f%10)for(var i=0;i<10*g;i++)var h="node_"+Math.ceil(Math.random()*(a-1))+" ",c=c+h,d=d+h,e=e+h;else for(i=0;i<g;i++)h="node_"+Math.ceil(Math.random()*(a-1))+" ",c+=h,d+=h,e+=h;0==f%2?(d+="class class1",e+="class class1"):(d=d+"class class"+Math.ceil(Math.random()*b),e=e+"class class"+Math.ceil(3*Math.random()));
d+="\n";e+="\n";c+="\n"}return[c,d,e]}
function GraphViewNode(a,b,c,d,e,f,g,i){this.node=b;this._graphView=a;this.cx=Math.ceil(c[0]);this.cy=Math.ceil(c[1]);this.r=d;this.color="black";null!=e&&(this.color=e);this.size=d;this.shape="ci";null!=f&&(this.shape=f);this.opacity=g;this.svgLabel=this.svgNode=null;this.noseStrokeWidth="1";null!=i&&(this.noseStrokeWidth=i);this.over=new Event(this);this.mouseout=new Event(this);this.mousedown=new Event(this);this.mouseup=new Event(this);this.click=new Event(this);this.dblclick=new Event(this);
