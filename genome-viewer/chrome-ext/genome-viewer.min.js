...
" selected.");Ext.getCmp(d.id+"chromosomeMenuButton").menu=d._getChromosomeMenu();d.genomeWidgetProperties=new GenomeWidgetProperties(d.species,{windowSize:1E6,pixelRatio:5.0E-4,id:d.id});null!=d.targetId&&d.draw()});this.customTracksAddedCount=1;$(window).resize(function(){});this.chromosome=13;this.position=32889611;this.drawing=0}GenomeViewer.prototype.setMenuBar=function(a){this.menuBar=a};GenomeViewer.prototype.draw=function(){null!=this.targetId&&this._getPanel(this.width,this.height);this._render()};
GenomeViewer.prototype._render=function(){var a=this.position-this.genomeWidgetProperties.windowSize,b=this.position+this.genomeWidgetProperties.windowSize;this._drawGenomeViewer();this.drawChromosome(this.chromosome,a,b);this._setScaleLabels()};
