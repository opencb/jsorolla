...
function GenomeViewer(a,b,c){var d=this;this.id="GenomeViewer:"+Math.round(1E4*Math.random());this.menuBar=null;this.width=$(document).width();this.height=$(document).height();this.lastPosition=26E7;this.targetId=null;this.species="hsa";this.speciesName="Homo sapiens";this.increment=5;null!=a&&(this.targetId=a);null!=b&&(this.species=b.species,this.speciesName=b.name,this.chromosome=parseInt(b.chromosome),this.position=parseInt(b.position));null!=c&&(null!=c.description&&(c.description="beta"),null!=
c.menuBar&&(this.menuBar=c.menuBar),null!=c.width&&(this.width=c.width),null!=c.height&&(this.height=c.height),null!=c.pluginsMenu&&(this.pluginsMenu=c.pluginsMenu),null!=c.chromosome&&(this.chromosome=parseInt(c.chromosome)),null!=c.position&&(this.position=parseInt(c.position)));this.onSpeciesChange=new Event;this.onZoomChange=new Event;this.onLastChrPosition=new Event;console.log(this.width+"x"+this.height);console.log(this.targetId);console.log(this.id);this.genomeWidget=null;this.genomeWidgetProperties=
new GenomeWidgetProperties(this.species,{width:this.width,windowSize:1E6,pixelRatio:5.0E-4,id:this.id,zoom:100,increment:this.increment});this.onSpeciesChange.addEventListener(function(a,b){d.species=b.species;d.speciesName=b.name;Ext.getCmp(d.id+"speciesMenuButton").setText(d.speciesName);Ext.example.msg("Species",d.speciesName+" selected.");Ext.getCmp(d.id+"chromosomeMenuButton").menu=d._getChromosomeMenu();d.genomeWidgetProperties=new GenomeWidgetProperties(d.species,{width:d.width,windowSize:1E6,
pixelRatio:5.0E-4,id:d.id,zoom:100,increment:d.increment});d.setLocation(b.chromosome,b.position);null!=d.targetId&&d.draw()});this.customTracksAddedCount=1;this.drawing=0}GenomeViewer.prototype.setMenuBar=function(a){this.menuBar=a};GenomeViewer.prototype.draw=function(){null!=this.targetId&&this._getPanel(this.width,this.height);this._render()};
