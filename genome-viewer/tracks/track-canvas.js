...
//	console.log(this.startViewBox+":"+this.endViewBox);
	...
	for ( var i = 0; i < this.regionAdapterList.length; i++) {
			...
			if(regionAdapter instanceof RuleRegionDataAdapter) regionAdapter.maxChromosomeSize = this.lastPosition;
			if(track instanceof RuleFeatureTrack) track.lastPosition = this.lastPosition;
